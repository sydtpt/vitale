...
const EXCECOES_DE_CORTE: readonly ExcecaoDeCorte[] = [
  ...
  {
    arquivo: 'scripts/bancada/relatorio.ts',
    forma: 'replace com ponto em classe',
    trecho: "s.replace(/[.,;:—–]/gu, ' ')",
    motivo:
      'palavrasDaCopia() (story 5.11): tira a pontuação para comparar a resposta com o exemplo do pedido palavra por ' +
      'palavra — não corta frase nenhuma, e a pontuação é justamente o que a regra da cópia manda ignorar',
  },
  {
    arquivo: "mobile/src/app/(tabs)/index.tsx",
