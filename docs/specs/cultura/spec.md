...
- **Busca degradada tem de ser visível ao usuário.** Quando o primário falha e o fallback responde, os resultados vêm com aparência de normalidade mas podem ser irrelevantes — a Open Library devolve livros religiosos com a mesma confiança de um acerto. Esconder isso faz a pessoa concluir "não existe" quando o correto é "tente de novo".
