...
const s = themed(() =>
  StyleSheet.create({
    ...
    vazioTxt: { fontSize: 14, fontFamily: fonts.sans, color: colors.ink2, textAlign: 'center' },
    btnManual: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: spacing.sm,
    ...
    btnManualTxt: { fontSize: 14, fontFamily: fonts.sansSemiBold },
    label: { fontSize: 13, fontFamily: fonts.sans, color: colors.ink2, marginBottom: spacing.xs, marginTop: spacing.md },
    ...
    sugestaoTxt: { fontSize: 13, fontFamily: fonts.sans, color: colors.ink2 },
    aviso: { fontSize: 13, fontFamily: fonts.sans, color: colors.ink2, marginBottom: spacing.sm },
    degradada: {
      flexDirection: 'row',
    ...
    degradadaTxt: { flex: 1, fontSize: 12, fontFamily: fonts.sans, color: colors.ink2, lineHeight: 17 },
    btnSalvar: {
    ...
    btnSalvarTxt: { color: '#fff', fontSize: 15, fontFamily: fonts.sansSemiBold },
  }),
);
