/**
 * Derivações puras do planner de treinos (mobile). Sem I/O.
 * ⚠️ Espelho de `web/src/app/features/treinos/data/planned-match.ts` — manter
 * as duas em sincronia (mesma regra de auto-match).
 *
 ...
 * descanso (`rest`) não auto-completam.
 */
import type { Activity, PlannedWorkout, WorkoutKind } from '@vitale/shared';
import { GPS_ACTIVITY_IDS } from './workout-types';
