 ...
 * piso de chroma e separação de visão normal (≥15). CVD na faixa de aviso é
 * aceitável com a legenda rotulada. Os papéis brown/deep/ink são secundários
 * (Funcional, HIIT, Musculação) e ficam abaixo desse piso — como já acontecia na
 * paleta original.
 */
